...
echo Run HCK studio...
cd "C:\Program Files (x86)\Windows Kits\8.0\Hardware Certification Kit\Studio\"
"C:\Program Files (x86)\Windows Kits\8.0\Hardware Certification Kit\Studio\hckstudio.exe"
